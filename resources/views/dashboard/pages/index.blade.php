    ...
    <div class="card card-xxl-stretch mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{trans(config('dashboard.trans_file').'static_pages')}}</span>
            ...
            <div class="card-toolbar">
                <a href="{{route('pages.create')}}" class="btn btn-sm btn-light-primary">
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                    ...
                    <thead>
                        <tr class="fw-bolder text-muted">
                            ...
                            <th class="min-w-150px">{{trans(config('dashboard.trans_file').'title')}}</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="text-dark fw-bolder d-block fs-6">{{$page->title}}</p>
                            </td>
                            <td>
                                @if($page->status)
                            ...
                            <td class="text-end">
                                ...
                                <a href="{{route('pages.edit', $page->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                <a href="#" onclick="deleteRow('{{route('pages.destroy', $page->id)}}', '{{csrf_token()}}')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
