    ...
    <div class="card card-xxl-stretch mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{trans(config('dashboard.trans_file').'areas')}}</span>
            ...
            <div class="card-toolbar">
                <a href="{{route('areas.create')}}" class="btn btn-sm btn-light-primary">
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                    ...
                    <thead>
                        <tr class="fw-bolder text-muted">
                            ...
                            <th class="min-w-150px">{{trans(config('dashboard.trans_file').'city')}}</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="text-dark fw-bolder fs-6">{{$area->name}}</p>
                            </td>
                            <td>
                                <p class="text-dark fw-bolder fs-6">{{$area->city->name}}</p>
                            </td>
                            <td>
                                @if($area->status)
                            ...
                            <td class="text-end">
                                ...
                                <a href="{{route('areas.edit', $area->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                <a href="#" onclick="deleteRow('{{route('areas.destroy', $area->id)}}', '{{csrf_token()}}')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
