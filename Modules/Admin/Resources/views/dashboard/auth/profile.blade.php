...
@section('page_path')
<!--begin::Title-->
<h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{trans('admin::dashboard.my_profile')}}</h1>
<!--end::Title-->
<!--begin::Separator-->
...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-dark">{{trans('admin::dashboard.my_profile')}}</li>
    <!--end::Item-->
</ul>
<!--end::Breadcrumb-->
@endsection
...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0">{{trans('admin::dashboard.my_profile')}}</h3>
        </div>
        <!--end::Card title-->
    </div>
    <!--begin::Card header-->
        ...
        <form action="{{route('admin-update-profile')}}" method="POST" id="adminForm" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        <!--begin::Image input-->
                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{url('img/dashboard/default-user.svg')}})">
                            <!--begin::Preview existing avatar-->
                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{$submitFormMethod == 'put' ? $admin->image_path : url('img/dashboard/default-user.svg')}})"></div>
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-1 col-form-label fw-bold fs-6">{{trans('admin::dashboard.name')}}</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-1 col-form-label fw-bold fs-6">{{trans('admin::dashboard.email')}}</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    ...
                    <!--begin::Label-->
                    <label class="col-lg-1 col-form-label fw-bold fs-6">{{trans('admin::dashboard.mobile')}}</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-5 fv-row fv-plugins-icon-container">
                        <input type="tel" name="mobile" class="form-control form-control-lg form-control-solid" placeholder="{{trans('admin::dashboard.mobile')}}" value="{{$submitFormMethod == 'put' ? $admin->mobile : old('mobile')}}">
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-1 col-form-label fw-bold fs-6">{{trans('admin::dashboard.password')}}</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-5 fv-row fv-plugins-icon-container">
                    ...
                    <!--end::Col-->
                    <!--begin::Label-->
                    <label class="col-lg-1 col-form-label fw-bold fs-6">{{trans('admin::dashboard.confirm_password')}}</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-5 fv-row fv-plugins-icon-container">
