...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-dark">{{trans(config('dashboard.trans_file').'areas')}}</li>
    <!--end::Item-->
</ul>
<!--end::Breadcrumb-->
@endsection
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">{{trans(config('dashboard.trans_file').'areas')}}</h3>
        ...
        <div class="card-body py-3">
            <form class="mb-15" action="{{route('areas.index')}}" method="GET">
                <div class="row mb-6">
                    ...
                    <div class="col-lg-4 mb-lg-0 mb-6">
                        <label>{{trans(config('dashboard.trans_file').'city')}}</label>
                ...
                <table id="kt_datatable_example_1" class="table table-striped table-bordered table-hover table-checkable dataTable dtr-inline">
                    ...
                    <thead>
                        <tr class="fw-bold fs-6 text-muted">
                            ...
                            <th class="min-w-100px" data-column-name="city">{{trans(config('dashboard.trans_file').'city')}}</th>
