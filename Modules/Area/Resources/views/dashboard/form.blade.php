...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <!--begin::Item-->
    <li class="breadcrumb-item text-muted">
        <a href="{{route('areas.index')}}" class="text-muted text-hover-primary">{{trans('area::dashboard.areas')}}</a>
    </li>
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item">
...
<div class="row">
    @include('area::dashboard.side_menu')
        ...
        <div id="kt_account_profile_details" class="collapse show">
            ...
            <form action="{{$submitFormRoute}}" method="POST" id="areaForm" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                    ...
                    <div class="tab-pane fade show active" id="more_info">
                        ...
                        <div class="card-toolbar mb-5">
                            <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0">
                                <li class="nav-item">
                                    <a id="name_en_tab" class="nav-link active" data-bs-toggle="tab" href="#name_en">{{trans('area::dashboard.name_en')}}</a>
                                </li>
                                <li class="nav-item">
                                    <a id="name_ar_tab" class="nav-link" data-bs-toggle="tab" href="#name_ar">{{trans('area::dashboard.name_ar')}}</a>
                                </li>
                            </ul>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="name_en" role="tabpanel">
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-2 col-form-label fw-bold fs-6">{{trans('area::dashboard.name_en')}}</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-10 fv-row fv-plugins-icon-container">
                                        <input type="text" name="name[en]" class="form-control form-control-lg form-control-solid" placeholder="{{trans('area::dashboard.name_en')}}" value="{{$submitFormMethod == 'put' ? $area->getTranslation('name', 'en') : old('name_en')}}">
                            ...
                            <div class="tab-pane fade" id="name_ar" role="tabpanel">
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-2 col-form-label fw-bold fs-6">{{trans('area::dashboard.name_ar')}}</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-10 fv-row fv-plugins-icon-container">
                                        <input type="text" name="name[ar]" class="form-control form-control-lg form-control-solid" placeholder="{{trans('area::dashboard.name_ar')}}" value="{{$submitFormMethod == 'put' ? $area->getTranslation('name', 'ar') : old('name_ar')}}">
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-2 col-form-label fw-bold fs-6">{{trans('area::dashboard.city')}}</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-10 fv-row fv-plugins-icon-container">
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <button type="reset" class="btn btn-white btn-active-light-primary me-2" onclick="window.location.reload()">{{trans('area::dashboard.cancel')}}</button>
                    <button type="submit" class="btn btn-primary" id="saveBtn">
                        <span class="spinner-border spinner-border-sm align-middle ms-2 d-none"></span>
                        {{trans('area::dashboard.save')}}
                    </button>
                </div>
                <!--end::Actions-->
            </form>
