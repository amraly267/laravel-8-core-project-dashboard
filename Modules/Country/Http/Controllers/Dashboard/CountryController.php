...
namespace Modules\Country\Http\Controllers\Dashboard;
...
use Modules\Country\Http\Requests\Dashboard\CountryRequest;
use PDF;
...
class CountryController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        {
            return view('country::'.$this->controllerResource.'index', compact('totalResults'));
        }
    }
